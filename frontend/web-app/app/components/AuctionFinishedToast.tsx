...
export default function AuctionFinishedToast({finishedAuction, auction}: Props){
    ...
    return (<Link href={`/auctions/details/${auction.id}`} className="flex flex-col items-center">
        <div className="flex flex-row items-center gap-2">
            ...
            <div className="flex flex-col">
                ...
                {finishedAuction.itemSold && finishedAuction.amount ? (
                    <p>Congrats to {finishedAuction.winner} who has won this auction for {currencyFormatter.format(finishedAuction.amount)}</p>
                ) : (
